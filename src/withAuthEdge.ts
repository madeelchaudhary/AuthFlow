...
interface WithAuthHandler {
  (req: NextRequest, res: NextResponse, jwt?: Record<string, any>): Promise<void | any>
}
 ...
 *
 */
export default function withAuthEdge({ config, pages }: WithAuthOptions, handler?: WithAuthHandler) {
